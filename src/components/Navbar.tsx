...
const Navbar = () => {
  ...
  return (
    <>
      <Link href="/">
        <div className="logo flex justify-center text-3xl font-bold text-pink-500 mt-8">playHive.</div>
      </Link>
        ...
        <div className="flex justify-between w-full h-full">
          ...
          <ul className="flex items-center">
            ...
            <li className="relative ml-4">
              ...
              {isDropdownVisible && (
                <ul className="absolute top-full right-0 mt-2 py-2 bg-white rounded-md shadow-xl text-black">
